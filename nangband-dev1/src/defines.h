 ...
 *
 * Some of the values here are chosen to preserve game (in)balance,
 * while others are hard-coded; eg, the definition of arrays in various
...
#define RF3_O_ASTRAL			0x00000400	/* Exists only in the Astral plane */
...
#define OPT_birth_pseudo_light   (OPT_BIRTH+10)
/* xxx xxx */
...
#define OPT_adult_pseudo_light   (OPT_ADULT+10)
/* xxx xxx */
...
#define birth_pseudo_light   op_ptr->opt[OPT_birth_pseudo_light]
/* xxx xxx */
...
#define adult_pseudo_light   op_ptr->opt[OPT_adult_pseudo_light]
/* xxx xxx */
