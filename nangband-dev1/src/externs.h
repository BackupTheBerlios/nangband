...
extern void forget_monster_light(void);
extern void update_monster_light(void);
...
extern void object_resists(const object_type *o_ptr, sbyte *resists);
extern void object_resists_known(const object_type *o_ptr, sbyte *resists);
extern void object_stat_bonuses(const object_type *o_ptr, sbyte *mods);
extern void object_stat_bonuses_known(const object_type *o_ptr, sbyte *mods);
...
extern void object_add_xtra(object_type *o_ptr, int xtra);
...
extern byte color_text_to_attr(char *string);
